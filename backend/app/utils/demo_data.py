...
DEMO_RAW_LOGS = [
    {"source": "auth-prod-01", "source_type": "auth_service", "raw_message": "User john.doe logged in successfully from 192.168.1.20", "received_at": utc_dt("2026-04-30T09:00:00Z"), "ip_address": "192.168.1.20", "hostname": "auth-prod-01", "metadata": {"event_name": "login_success", "username": "john.doe", "result": "success", "user_agent": "Mozilla/5.0", "asset_importance": "high", "demo_scenario": "normal_login"}},
]

for index in range(1, 9):
    DEMO_RAW_LOGS.append({"source": "auth-prod-01", "source_type": "auth_service", "raw_message": "Failed login for user admin from 10.0.0.55", "received_at": utc_dt(f"2026-04-30T09:0{index}:00Z"), "ip_address": "10.0.0.55", "hostname": "auth-prod-01", "metadata": {"event_name": "login_failed", "username": "admin", "result": "failed", "user_agent": "Mozilla/5.0", "asset_importance": "high", "demo_scenario": "brute_force"}})
