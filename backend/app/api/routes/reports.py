...
def daily(db: Annotated[Session, Depends(get_db)], current_user: Annotated[User, Depends(require_roles("admin","analyst"))], start_date: datetime | None = None, end_date: datetime | None = None):
...
def weekly(db: Annotated[Session, Depends(get_db)], current_user: Annotated[User, Depends(require_roles("admin","analyst"))], start_date: datetime | None = None, end_date: datetime | None = None):
...
def top_risky_ips(db: Annotated[Session, Depends(get_db)], current_user: Annotated[User, Depends(require_roles("admin","analyst"))], start_date: datetime | None = None, end_date: datetime | None = None, limit: int = Query(10, ge=1, le=50)):
...
def targeted_users(db: Annotated[Session, Depends(get_db)], current_user: Annotated[User, Depends(require_roles("admin","analyst"))], start_date: datetime | None = None, end_date: datetime | None = None, limit: int = Query(10, ge=1, le=50)):
...
def by_severity(db: Annotated[Session, Depends(get_db)], current_user: Annotated[User, Depends(require_roles("admin","analyst"))], start_date: datetime | None = None, end_date: datetime | None = None):
...
def open_vs_resolved(db: Annotated[Session, Depends(get_db)], current_user: Annotated[User, Depends(require_roles("admin","analyst"))], start_date: datetime | None = None, end_date: datetime | None = None):
...
def mttr(db: Annotated[Session, Depends(get_db)], current_user: Annotated[User, Depends(require_roles("admin","analyst"))], start_date: datetime | None = None, end_date: datetime | None = None):
