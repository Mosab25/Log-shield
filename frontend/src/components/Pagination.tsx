export function Pagination({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-800/80 px-5 py-4">
      <p className="text-sm font-medium text-slate-400">Page {page} of {pages} - Total {total}</p>
