  ...
  return (
    <section className="soc-page-header">
      <div className="min-w-0">
        ...
        <h1 className="mt-3 truncate text-3xl font-black tracking-tight text-white sm:text-4xl">{title}</h1>
...
export function EmptyState({
  ...
  return (
    <div className="soc-empty">
      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl border border-slate-700/80 bg-slate-950/80 text-cyan-200">
...
export function ErrorState({
  ...
  return (
    <div className="rounded-2xl border border-amber-300/25 bg-amber-400/10 px-4 py-3 text-sm text-amber-100 shadow-[0_0_35px_rgba(251,191,36,0.08)]">
