...
export const moduleThemes: Record<ModuleThemeKey, ModuleTheme> = {
  ...
  threatIntelligence: moduleTheme("threatIntelligence", "Threat Research Hub", "Radar", "External intelligence, CVE research, and curated knowledge context.", "intelligence grid"),
  cveSearch: moduleTheme("cveSearch", "Vulnerability Explorer", "Bug", "Vulnerability research and severity analysis.", "research grid"),
  ...
  socToolkit: moduleTheme("socToolkit", "Security Operations Toolkit", "Wrench", "Technical utilities and analyst artifact tools.", "terminal utilities"),
