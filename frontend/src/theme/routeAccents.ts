...
export const ROUTE_ACCENTS: RouteAccent[] = [
  ...
  routeAccent("Dashboard", "/dashboard", "Unified security operations visibility hub"),
  routeAccent("Security Tools", "/tools", "Analyst utility belt"),
  ...
  routeAccent("Research Hub", ["/research-hub", "/threats", "/threats/:id", "/threat-intelligence", "/threat-intel"], "CVE research and curated threat context"),
  routeAccent("Vulnerability Explorer", "/cve-search", "Vulnerability database search"),
