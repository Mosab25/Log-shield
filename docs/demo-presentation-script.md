# LogShield Demo Presentation Script
...
1. Login as admin.
2. Open Dashboard.
3. Review raw and normalized logs.
4. Review detection rules mapped to MITRE ATT&CK.
5. Open Alerts and inspect risk score, severity, assignment, and status.
6. Open Alert Details to review related logs, notes, status history, and risk explanation.
